  ...
  task :generate_groups do
    ...
    synonyms = {
      "CLARO" => ["CELL CLARO", "CELL CLARO CORPORATE", "CELLSHOPP-CLARO", "CENTER CELL - CLARO", 
          "LOUREIRO & ALMEIDAAGENTE AUTORIZADO CLARO", "NEXCOM", "NEXCOM CLARO", "EMBRATEL", "EMPRESA BRASILEIRA DE TELECOMUNICAÇÕES"],
      "BANCO ITAU" => ["BANCO ITAU.*", "BANCO FIAT.*", "ITAU.*", "CIA ITAÚLEASING.*", "UNICARD.*", 
          "HIPERCARD", "LUIZACRED", "DIBENS LEASING.*"],
      "BRADESCO" => ["BANCO BRADESCO .*", "BRADESCO .*", "IBIBANK.*", "IBIODONTO", "IBI", "IBI CRED", "IBI CRED"],
      "OI" => ["OI FIXO", "OI CELULAR", "OI TV", "BRASIL TELECOM.*", "TELEMAR.*"],
